                ...
                <div className="flip-card col-sm-12 col-md-6 col-lg-3">
                  <div className="flip-card-inner">
                    <div className="flip-card-front">
                      <img
                        className="img-fluid"
                        src="https://www.vpnfan.com/wp-content/uploads/2018/08/dazn-logo.jpg"
                        alt="Avatar"
                        style={styles.img1}
                      />
                    </div>
                    <div className="flip-card-back">
                      <p style={styles.back} className="amber-text">
                        DAZN
                      </p>
                      <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://www.dazn.com/en-CA/welcome"
                        className="btn btn-sm btn-fb  wave-effect"
                      >
                        <i className="fas fa-window-maximize pr-1"></i>Watch Now
                      </a>
                    </div>
                  </div>
                </div>
                <div className="flip-card col-sm-12 col-md-6 col-lg-3">
                  <div className="flip-card-inner">
                    <div className="flip-card-front">
                      <img
                        className="img-fluid"
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRFSOi1RbSjJESIQwnOV3AVzLv1cP62pHuyMw&usqp=CAU"
                        alt="Avatar"
                        style={styles.img1}
                      />
                    </div>
                    <div className="flip-card-back">
                      ...
                      <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://www.tsn.ca/soccer"
                        className="btn btn-sm btn-fb  wave-effect"
                      >
                        <i className="fas fa-window-maximize pr-1"></i>Visit the
                        Webpage
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flip-card-inner">
                    ...
                    <div className="flip-card-back">
                      ...
                      <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://www.sportsnet.ca/soccer/"
                        className="btn btn-sm btn-fb  wave-effect"
                      >
                        <i className="fas fa-window-maximize pr-1"></i>Visit the
                        Webpage
                  ...
                  <div className="flip-card-inner">
                    ...
                    <div className="flip-card-back">
                      ...
                      <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://connect.beinsports.com/ca/"
                        className="btn btn-sm btn-fb  wave-effect"
                      >
                        <i className="fas fa-window-maximize pr-1"></i>Watch Now
                      </a>
